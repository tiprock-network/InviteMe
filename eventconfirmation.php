        ...
        if($_SERVER["REQUEST_METHOD"] == "POST"){
            if(!$_POST['eventfrmhead'] || !$_POST['eventDateTime'] || !$_POST['eventType'] || !$_POST['eventLoc'] || !$_POST['eventCountry'] || !$_POST['eventDuration'] || !$_POST['eventfrmdesc']){
               ...
               if(isset($_SESSION['id'])){
                ...
                //create sql query
                $insert_event = "INSERT INTO eventTbl(eventId,customerId,eventName,eventLoc,eventCountry,eventDesc,eventType,eventTime,eventDuration,eventPrice,eventLimit) 
                VALUES ('$eId','$custId','$ehead','$eLoc','$eCountry','$eDesc','$etype','$etimedate','$eDuration','$ePrice','$elimit');";
                ...
                if(!$result){
                    ...
                    echo '<div class="event_creationCont">
                        ...
                        <div class="body">
                            ...
                            <br><br>
                            <a href="create.php">Click here to go back</a>
                        </div>
                    </div>';
                }else{
                    echo '<div class="event_creationCont">
